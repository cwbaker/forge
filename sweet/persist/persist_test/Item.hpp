//
// Item.hpp
// Copyright (c) 2006 - 2008 Charles Baker.  All rights reserved.
//
...
void
sweet::persist::Item::enter( Archive& archive )
{
...
template <class Archive>
void
sweet::persist::Item::exit( Archive& archive )
{
}
...
template <class Archive> 
void 
sweet::persist::Item::persist( Archive& archive )
{
