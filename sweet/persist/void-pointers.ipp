...
void save( Archive& archive, int mode, const char* name, const void*& object )
{
...
template <class Archive>
void load( Archive& archive, int mode, const char* name, const void*& object )
{
...
template <class Archive>
void resolve( Archive& archive, int mode, const void*& object )
{
    SWEET_ASSERT( mode == MODE_REFERENCE );
