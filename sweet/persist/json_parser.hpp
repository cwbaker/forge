...
{
    { json_SYMBOL_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_4, NULL },
    { json_SYMBOL_begin_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_5, NULL },
    { json_SYMBOL_string, sweet::parser::TRANSITION_SHIFT, &json_parser_state_9, NULL },
};
...
{
    { json_SYMBOL_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_17, NULL },
    { json_SYMBOL_begin_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_5, NULL },
    { json_SYMBOL_contents, sweet::parser::TRANSITION_SHIFT, &json_parser_state_7, NULL },
    { json_SYMBOL_content, sweet::parser::TRANSITION_SHIFT, &json_parser_state_16, NULL },
    { json_SYMBOL_attribute, sweet::parser::TRANSITION_SHIFT, &json_parser_state_18, NULL },
    { json_SYMBOL_string, sweet::parser::TRANSITION_SHIFT, &json_parser_state_10, NULL },
};
...
const sweet::parser::ParserState json_parser_state_5 =
{
    ...
    json_parser_state_5_transitions + 6
};
...
const sweet::parser::ParserTransition json_parser_state_6_transitions[] = 
{
    { json_SYMBOL_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_17, NULL },
    { json_SYMBOL_begin_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_5, NULL },
    { json_SYMBOL_content, sweet::parser::TRANSITION_SHIFT, &json_parser_state_15, NULL },
    { json_SYMBOL_attribute, sweet::parser::TRANSITION_SHIFT, &json_parser_state_18, NULL },
    { json_SYMBOL_string, sweet::parser::TRANSITION_SHIFT, &json_parser_state_10, NULL },
};
...
const sweet::parser::ParserState json_parser_state_6 =
{
    ...
    json_parser_state_6_transitions + 5
};


const sweet::parser::ParserTransition json_parser_state_7_transitions[] = 
{
    { json_SYMBOL_end_element, sweet::parser::TRANSITION_SHIFT, &json_parser_state_8, NULL },
    { json_SYMBOL_comma_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_6, NULL },
    { json_SYMBOL_right_curly_brace_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_14, NULL },
};
...
const sweet::parser::ParserState json_parser_state_7 =
{
    ...
    json_parser_state_7_transitions + 3
};
...
const sweet::parser::ParserState json_parser_state_8 =
{
    ...
    json_parser_state_8_transitions + 3
};


const sweet::parser::ParserTransition json_parser_state_9_transitions[] = 
{
    { json_SYMBOL_colon_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_11, NULL },
};
...
{
    { json_SYMBOL_colon_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_12, NULL },
};
...
const sweet::parser::ParserState json_parser_state_10 =
{
    ...
    json_parser_state_10_transitions + 1
};


const sweet::parser::ParserTransition json_parser_state_11_transitions[] = 
{
    { json_SYMBOL_left_curly_brace_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_13, NULL },
};
...
const sweet::parser::ParserState json_parser_state_11 =
{
    ...
    json_parser_state_11_transitions + 1
};
...
{
    { json_SYMBOL_left_curly_brace_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_13, NULL },
    { json_SYMBOL_boolean, sweet::parser::TRANSITION_SHIFT, &json_parser_state_20, NULL },
    { json_SYMBOL_string, sweet::parser::TRANSITION_SHIFT, &json_parser_state_23, NULL },
    { json_SYMBOL_null, sweet::parser::TRANSITION_SHIFT, &json_parser_state_19, NULL },
    { json_SYMBOL_true_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_24, NULL },
    { json_SYMBOL_false_terminal, sweet::parser::TRANSITION_SHIFT, &json_parser_state_25, NULL },
    { json_SYMBOL_integer, sweet::parser::TRANSITION_SHIFT, &json_parser_state_21, NULL },
    { json_SYMBOL_real, sweet::parser::TRANSITION_SHIFT, &json_parser_state_22, NULL },
};
...
const sweet::parser::ParserState json_parser_state_12 =
{
    ...
    json_parser_state_12_transitions + 8
};
...
const sweet::parser::ParserState json_parser_state_13 =
{
    ...
    json_parser_state_13_transitions + 1
};


const sweet::parser::ParserTransition json_parser_state_14_transitions[] = 
{
    { json_SYMBOL_dot_end, sweet::parser::TRANSITION_REDUCE, NULL, &json_parser_production_4 },
...
const sweet::parser::ParserState json_parser_state_14 =
{
    ...
    json_parser_state_14_transitions + 3
};
...
{
    { json_SYMBOL_dot_end, sweet::parser::TRANSITION_REDUCE, NULL, &json_parser_production_13 },
...
{
    { json_SYMBOL_dot_end, sweet::parser::TRANSITION_REDUCE, NULL, &json_parser_production_17 },
...
const sweet::parser::ParserState json_parser_state_25 =
{
    ...
    json_parser_state_25_transitions + 3
};
