...
#ifndef SWEET_PERSIST_JSONWRITER_HPP_INCLUDED
#define SWEET_PERSIST_JSONWRITER_HPP_INCLUDED
...
/**
// Writes JSON archives.
*/
class SWEET_PERSIST_DECLSPEC JsonWriter : public TextWriter
{
    public:
        JsonWriter();
