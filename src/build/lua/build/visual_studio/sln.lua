...
local function generate_projects( write, targets )
    local PROJECT = [[
...
EndProject
    ...
    for _, target in ipairs(targets) do
        ...
        write( PROJECT, name, native(relative(filename)), target.uuid );
    end
end
...
function generate( filename, targets )
    print( leaf(filename) );
    ...
    generate_projects( write, targets );
    generate_directories( write, {} );
    generate_global( write );
    generate_files( write, {} );
    generate_solution_configuration_platforms( write, targets );
    generate_project_configuration_platforms( write, targets );
    generate_solution_properties( write );
    generate_nested_projects( write, {} );
