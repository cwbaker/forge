...
class Context 
{
    ...
    std::vector<std::filesystem::path> directories_; ///< The stack of working directories for this context (the element at the top is the current working directory).
    ...
    public:
        ...
        void push_directory( const std::filesystem::path& directory );
        void pop_directory();
