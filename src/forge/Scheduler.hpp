...
class Scheduler
{
    ...
    public:
        ...
        void script( const std::filesystem::path& working_directory, const std::string& script );
        void command( const std::filesystem::path& working_directory, const std::string& command );
