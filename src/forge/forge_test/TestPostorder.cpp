...
SUITE( TestPostorder )
{
    ...
    {
        const char* script = 
            "local ErrorInPostorderVisit = TargetPrototype( 'ErrorInPostorderVisit' ); \n"
        ...
        ;        
        test( script );
        CHECK_EQUAL( "[string \"local ErrorInPostorderVisit = TargetPrototype...\"]:3: Error in postorder visit", messages[0] );
    ...
    {
        const char* script = 
            "local UnexpectedErrorInPostorderVisit = TargetPrototype( 'UnexpectedErrorInPostorderVisit' ); \n"
    ...
    {
        const char* script = 
            "local RecursivePostorderError = TargetPrototype( 'RecursivePostorderError' ); \n"
